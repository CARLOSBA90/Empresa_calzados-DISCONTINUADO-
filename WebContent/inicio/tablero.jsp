              ...
              <li class="nav-item">
                ...
                <div id="MenuCliente" class="collapse" aria-labelledby="cabeceraCliente" data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="ControladorCliente?instruccion=listar">Nuevo cliente</a>
                    <a class="collapse-item" href="clientes/agregar.jsp">Ver listado</a>
                ...
                <div class="container-fluid">
                     ...
                     <c:set var="Noticias" value="${TABLERO[tamano-i]}" />
                      <div class="card shadow mb-4">
                        <div class="card-header py-3">
                          <h6 class="m-0 font-weight-bold text-primary">${Noticias.titulo}  ${Noticias.fecha}</h6>
                        </div>
                        <div class="card-body">
                          <p>${Noticias.texto}</p>
                        </div>
                  ...
                  <%-- Formulario para envio de nueva noticia en tablero--%> 
                   ...
                   <form name="form1" method="get" action="ControladorInicio">
                      ...
                      <div class="card shadow mb-4">
                        <div class="card-header py-3">
                          <h6 class="m-0 font-weight-bold text-primary">Titulo <input type="text" name="titulo" id="titulo" required width="100%" ></h6>
                        </div>
                        <div class="card-body">
                          <textarea rows ="5" cols="60" name="texto" id="texto" style="resize: none;" onfocus="this.value=''" required >Escribir nota aqui..</textarea>
                          <input type="reset" name="reset" id="reset" value="Borrar" ><input type="submit" name="submit" id="submit" value="Enviar" onclick="resetear()">   
                        </div>
                      </div>
